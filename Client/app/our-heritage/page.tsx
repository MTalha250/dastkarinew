...
const artisans = [
  {
    ...
    story:
      "With over 40 years of experience in traditional Islamic calligraphy, Ustad Abdul Kareem has dedicated his life to preserving the ancient art of Arabic and Persian script. His work adorns numerous historical monuments and private collections.",
  ...
  },
  {
    ...
    story:
      "A third-generation textile artist, Amira Bibi carries forward the legacy of intricate embroidery and mirror work that has been passed down through generations. Her pieces tell stories of cultural motifs and traditional patterns.",
  ...
  },
  {
    ...
    story:
      "Trained in the traditional Mughal miniature painting techniques, Mohammad Rafi brings historical scenes to life with incredible detail and precision. His work preserves the storytelling tradition of South Asian art.",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-800 max-w-3xl mx-auto leading-relaxed">
              At DastKari, we are custodians of centuries-old artistic
              traditions, preserving and celebrating the rich cultural heritage
              of South Asia through our carefully curated collection and master
              artisans.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              >
                <h3 className="text-xl font-serif text-amber-900 mb-4">
                  Mughal Era Excellence
                </h3>
                <p className="text-amber-800">
                  Our collection features pieces that draw inspiration from the
                  golden age of Mughal artistry, where master craftsmen created
                  works of unparalleled beauty and sophistication.
                </p>
              </motion.div>
              <motion.div
                className="bg-white p-8 border border-amber-200 shadow-sm"
              ...
              >
                ...
                <p className="text-amber-800">
                  Each region of South Asia contributes its unique artistic
                  vocabulary, from the intricate patterns of Kashmir to the bold
                  geometrics of Sindh.
                </p>
              </motion.div>
            </div>
            <div className="space-y-8 md:mt-12">
              ...
              >
                ...
                <p className="text-amber-800">
                  Islamic calligraphy and geometric patterns blend with local
                  motifs, creating a unique artistic language that speaks of
                  both devotion and cultural synthesis.
                </p>
              </motion.div>
              <motion.div
                className="bg-white p-8 border border-amber-200 shadow-sm"
              ...
              >
                ...
                <p className="text-amber-800">
                  While honoring traditional techniques, we embrace contemporary
                  interpretations that keep our cultural heritage vibrant and
                  relevant.
                </p>
              </motion.div>
            </div>
