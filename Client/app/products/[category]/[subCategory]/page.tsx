  ...
  return (
    <div className="pt-32 px-6 md:px-12 lg:px-24">
      <SEO
        ...
        )}, ${decodeURIComponent(category.toString())} | DastKari`}
        description={`Immerse yourself in our carefully curated selection of ${decodeURIComponent(
          subCategory.toString()
        )} from the distinguished ${decodeURIComponent(
          category.toString()
        )} collection. Each piece encapsulates centuries of artistic mastery, bringing the richness of South Asian heritage into your space.`}
      />
      <div className="text-center mb-12 flex flex-col items-center">
        ...
        <p className="text-sm md:text-base mt-4 text-gray-600 max-w-xl">
          Immerse yourself in our carefully curated selection of{" "}
          {decodeURIComponent(subCategory.toString())} from the distinguished{" "}
          {decodeURIComponent(category.toString())} collection. Each piece
          encapsulates centuries of artistic mastery, bringing the richness of
          South Asian heritage into your space.
        </p>
      </div>
