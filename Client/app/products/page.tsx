...
const page = () => {
  ...
  return (
    <div className="pt-32 px-6 md:px-12 lg:px-24">
      <SEO
        title="Catalogue | DastKari"
        description="Discover the timeless elegance of South Asian heritage through our curated selection of masterpieces. From exquisite Mughal miniatures to masterful Persian calligraphy, each piece in our collection carries centuries of artistic legacy and royal patronage. Explore authenticated artifacts that blend cultural richness with artistic excellence, carefully chosen to bring the grandeur of traditional craftsmanship into contemporary spaces."
      />
      <div className="text-center mb-12 flex flex-col items-center">
        ...
        <p className="text-sm md:text-base mt-4 text-gray-600 max-w-xl">
          Discover the timeless elegance of South Asian heritage through our
          curated selection of masterpieces. From exquisite Mughal miniatures to
          masterful Persian calligraphy, each piece in our collection carries
          centuries of artistic legacy and royal patronage. Explore
          authenticated artifacts that blend cultural richness with artistic
          excellence, carefully chosen to bring the grandeur of traditional
